...
namespace QLCafe.DTO
{
    public class DTO_KetCa
    {
        ...
        public DTO_KetCa(int getID, DateTime getThoiGianBatDau, DateTime getThoiGianKetThuc, double getTongTienSauCa, int getIDNhanVien, string getTenNguoiDung, double getTienGio, double getTienNuoc, string tongGio)
        {
            this.ID = getID;
        ...
        public DTO_KetCa(DataRow dr)
        {
            ...
            this.TongGio = dr["TongThoiGian"].ToString();
        }
    }
}
